...
<template>
  <div v-if="store.actions.length > 0" class="shadow-md bg-white rounded-md mt-5 md:-mt-8">
    ...
    <div class="bg-temper-grey items-center p-2 md:p-4">
      <transition-group name="fade" tag="div">
        <div v-for="action in store.actions" :key="action.id">
          <div class="action shadow-md bg-white p-2 flex w-full items-center justify-between border-b">
            ...
            <button
              class="bg-temper-green text-neutral-700 font-sans font-semibold rounded-lg text-center px-2 py-1 whitespace-nowrap text-sm sm:px-4 sm:py-2 hover:bg-green-300"
